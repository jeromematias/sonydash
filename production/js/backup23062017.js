var WeeksPeriod = [], MonthsPeriod = [], QuartersPeriod = [], YearsPeriod = [], magicType = 'bar', GetWeekRanges = [];
...
function InitializeDashboardInpouts(){         
    ...
    .done(function(data){                  
            ...
            /*for (var i in data.GetLastDates){
                GetLastDates.push({'AreaID':data.GetLastDates[i].AreadID, 'MaxPeriod':data.GetLastDates[i].MaxPeriod});
            }*/
            var ChannelBrandIDs = [];
...
function getPeriodDate(p, y, periodtype) {
    ...
    if($('#periodtype').val() == 1){        
        ...
        ISOweekEND.setDate(periodEndDate.getDate() - periodEndDate.getDay() + 1);

        
        var ddd = ISOweekEND.getDate()-1;
        ...
        $('#PeriodInfo').text(diffDays+"Days, "+dd + "-" + mm + "-" + yy + " - " + ddd + "-" + mmm + "-" + yyy);        
...
function GetCompetitives(UnitID){
    ...
    $.ajax({
        url: "competitive.php?AreaID=" + localStorage["AreaID"] + "&DemographicID=" + localStorage["DemographicID"] +
            "&ChannelBrandID=" + localStorage["ChannelBrandID"] + "&UnitID=" + localStorage["CompetitiveUnitID"] + "&PeriodTypeID=" + localStorage["PeriodTypeID"] + "&PeriodNumber=" + localStorage["PeriodNumber"] + "&IsPrimeTime=" + localStorage["isPrimeTime"]+ "&ReferencePeriods="+localStorage["ReferencePeriods"],
            type: "GET",
            cache : false    
    })
    .done(function(data){
...
function ratings(targetgroupname, channelbrandid, unitid, periodtypeid, periodnumber, refperiods, isPrimeTime,RegionID) {            
        //alert("RatingPerformance.php?version="+ $.now() +"&targetgroupname=" + targetgroupname + "&channelbrandid=" + channelbrandid + "&unitid=" + unitid + "&periodtypeid=" + periodtypeid + "&periodnumber=" + periodnumber + "&refperiods=" + refperiods + "&isPrimeTime=" + isPrimeTime+ "&RegionID=" + RegionID)
        $.ajax({
            url: "RatingPerformance.php?version="+ $.now() +"&targetgroupname=" + targetgroupname + "&channelbrandid=" + channelbrandid + "&unitid=" + unitid + "&periodtypeid=" + periodtypeid + "&periodnumber=" + periodnumber + "&refperiods=" + refperiods + "&isPrimeTime=" + isPrimeTime+ "&RegionID=" + RegionID,
            type: "GET",
            cache : false
        })
        .done(function(data) {            
                    ...
                    for (var k = 0; k < data.length; k++) {
                        ...
                        if ((data[k].areaid == AreaID) && (data[k].ChannelBrandID == ChannelBrandID)) {
                            ...
                            if(data[k].IsRegionRow == 0){
                                ...
                                var Percent = '';
                                if (data[k].ReferenceValue == 0) {
                                    if(data[k].CurrentValue == 0){
                                        Percent = '-';
                                    }else{
                                        Percent = data[k].CurrentValue +PercentTag+ ' (N/A)*';
                                    }                                    
                                } else {
                                ...
                                if(MinDateNumber <= minrefperiods && MaxDateNumber >= $('#period').val()){
                                    if(Percent == '-'){
                                        EachRow += '<td><table id="hiddenTable"><tr><td></td><td>-</td><td></td></tr></table></td>';
                                    }else{
                                        EachRow += '<td id="CELLID' + data[k].areaid + "" + data[k].ChannelBrandID + '" onClick="passIDs(' + data[k].areaid + ',' + data[k].DemographicID + ',' + data[k].ChannelBrandID + ',\'' + data[k].AreaName + '\',\'' + data[k].TargetCode + '\',\''+ data[k].ChannelBrandName +'\',\''+ data[k].ChannelID +'\',\'' + data[k].CountryCode + '\',\'' + data[k].IsRegionRow + '\',\'' + data[k].RegionID + '\')">&#09;' + Percent + '</td>';
                                    }
                                }else{
                                    EachRow += '<td id="CELLID' + data[k].areaid + "" + data[k].ChannelBrandID + '" onClick="passIDs(' + data[k].areaid + ',' + data[k].DemographicID + ',' + data[k].ChannelBrandID + ',\'' + data[k].AreaName + '\',\'' + data[k].TargetCode + '\',\''+ data[k].ChannelBrandName +'\',\''+ data[k].ChannelID +'\',\'' + data[k].CountryCode + '\',\'' + data[k].IsRegionRow + '\',\'' + data[k].RegionID + '\')">&#09;(N/A)!</td>';
                                }
            ...
            for(var g in GetWeekRanges){
                if($('#periodtype').val() == 1){
                ...
                }else if($('#periodtype').val() == 2 || $('#periodtype').val() == 3){
                    if(MinWeek <= GetMaxMinDate(GetYearNum(GetWeekRanges[g].MinWeekNumber),GetWeekNum(GetWeekRanges[g].MinWeekNumber),$('#periodtype').val())){
                        MinWeek = GetMaxMinDate(GetYearNum(GetWeekRanges[g].MinWeekNumber),GetWeekNum(GetWeekRanges[g].MinWeekNumber),$('#periodtype').val());                    
                    }
                    if(MaxWeek >= GetMaxMinDate(GetYearNum(GetWeekRanges[g].MaxWeekNumber),GetWeekNum(GetWeekRanges[g].MaxWeekNumber),$('#periodtype').val())){
                    ...
                    if(GetYearNum(MinWeek) <= GetMaxMinDate(GetYearNum(GetWeekRanges[g].MinWeekNumber),GetWeekNum(GetWeekRanges[g].MinWeekNumber),$('#periodtype').val())){
                        MinWeek = GetMaxMinDate(GetYearNum(GetWeekRanges[g].MinWeekNumber),GetWeekNum(GetWeekRanges[g].MinWeekNumber),$('#periodtype').val());                    
                    }
                    if(GetYearNum(MaxWeek) >= GetMaxMinDate(GetYearNum(GetWeekRanges[g].MaxWeekNumber),GetWeekNum(GetWeekRanges[g].MaxWeekNumber),$('#periodtype').val())){
                        MaxWeek = GetMaxMinDate(GetYearNum(GetWeekRanges[g].MaxWeekNumber),GetWeekNum(GetWeekRanges[g].MaxWeekNumber),$('#periodtype').val());
                    }                                                                                                                                                                                                        
                } 
            }
                                    ...
                                    if (localStorage["ValueFormatPercent"] == 1) {
                                        if (data[m].ReferenceValue == 0) {
                                            if(data[m].CurrentValue == 0){
                                                ...
                                                Percent = data[m].CurrentValue +PercentTag+ ' (N/A)*';
                                            }                                    
                                        } else {
                                            ...
                                            var dataCurrent = parseFloat(data[m].CurrentValue.replace(/,/g, ''));
                                            var dataReference = parseFloat(data[m].ReferenceValue.replace(/,/g, ''));
                                            var decimalNum = 1;
                                            var unitDecimal = 3;
                                            if($('#unittype').val() == 4){
                                                unitDecimal = 0;
                                        ...
                                        /*if(Percent == '-'){
                                            ...
                                            if(localStorage["UnitID"] != 3){
                                                if(MinWeek <= minrefperiods && MaxWeek >= $('#period').val()){
                                                    ...
                                                    EachRow += '<td id="GLOBALID' + data[m].RegionID + "" + data[m].ChannelBrandID + '" onClick="passIDs(' + data[m].areaid + ',' + data[m].DemographicID + ',' + data[m].ChannelBrandID + ',\'' + data[m].AreaName + '\',\'' + data[m].TargetCode + '\',\''+ data[m].ChannelBrandName +'\',\''+ data[m].ChannelID +'\',\'' + data[m].CountryCode + '\',\'' + data[m].IsRegionRow + '\',\'' + data[m].RegionID + '\')">&#09;(N/A)!</td>';
                                                }
                                            }else{
                                                EachRow += '<td>-</td>';
                                            }                                            
                                        ...
                                        if (data[m].ReferenceValue == 0) {
                                            if(localStorage["UnitID"] != 3){
                                                ...
                                                EachRow += '<td><table id="hiddenTable"><tr><td></td><td>-</td><td></td></tr></table></td>'
                                                    ...
                                                    EachRow += '<td>'+ data[m].CurrentValue +PercentTag+ ' (N/A)*' +'</td>';
                                                }
                                            }else{
                                                EachRow += '<td>-</td>';
                                            }                                                                                
...
function GetMaxMinDate(y,w,type){
...
function exportTable(targetgroupname, channelbrandid, unitid, periodtypeid, periodnumber, refperiods, isPrimeTime, filetype) {
    $.ajax({
            url: "RatingPerformance.php?targetgroupname=" + targetgroupname + "&channelbrandid=" + channelbrandid + "&unitid=" + unitid + "&periodtypeid=" + periodtypeid + "&periodnumber=" + periodnumber + "&refperiods=" + refperiods + "&isPrimeTime=" + isPrimeTime,
            type: "GET",
            cache : false
        })
        .done(function(data) {
...
function ExportTrending(filetype) {
    $.ajax({
            url: "TrendingGraph.php?DemographicID=" + localStorage["DemographicID"] +
                ...
                "&isPrimeTime=" + localStorage["isPrimeTime"],
            type: "GET",
            cache : false
        })
        .done(function(data) {
...
function exportCompetitive(){
    $.ajax({
            url: "competitive.php?AreaID=" + localStorage["AreaID"] + "&DemographicID=" + localStorage["DemographicID"] +
            "&ChannelBrandID=" + localStorage["ChannelBrandID"] + "&UnitID=" + localStorage["CompetitiveUnitID"] + "&PeriodTypeID=" + localStorage["PeriodTypeID"] + "&PeriodNumber=" + localStorage["PeriodNumber"] + "&IsPrimeTime=" + localStorage["isPrimeTime"],
            type: "GET",
            cache : false
        })
        .done(function(data) {
...
function initializedNavigation() {
    ...
    ratings(localStorage["TargetGroupName"], localStorage["ChannelBrandIDs"], localStorage["UnitID"], localStorage["PeriodTypeID"], localStorage["PeriodNumber"], localStorage["ReferencePeriods"], localStorage["isPrimeTime"],$('#area').val());
...
//********************************************************************Exporting functions************************************************************************************************ 
    ...
    function RatingsExportToXlsx() {
        exportTable(localStorage["TargetGroupName"],localStorage["ChannelBrandIDs"],localStorage["UnitID"],localStorage["PeriodTypeID"],localStorage["PeriodNumber"],localStorage["ReferencePeriods"],localStorage["isPrimeTime"],'xlsx');        
    }
