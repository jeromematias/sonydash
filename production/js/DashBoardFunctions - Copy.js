...
function getPeriodDate(p, y, periodtype) {
    ...
    if($('#periodtype').val() == 1){        
        ...
        if (dow <= 4){
            ISOweekEND.setDate(periodEndDate.getDate() - periodEndDate.getDay());
        }
        else{
            ISOweekEND.setDate(periodEndDate.getDate() + 7 - periodEndDate.getDay());
        }
        var ddd = ISOweekEND.getDate();
        var mmm = ISOweekEND.getMonth()+1;
        var yyy = ISOweekEND.getFullYear();
        var timeDiff = Math.abs(ISOweekEND.getTime() - ISOweekStart.getTime()) + 1;
        ...
        $('#PeriodInfo').text(ddd + "Days, " + dd + "-" + mm + "-" + yy + " - " +ddd + "-" + mmm + "-" + yyy);
        ...
        if( lastDate.getTime() < periodEndDate.getTime() ){
